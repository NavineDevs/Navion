...
const INJECT = (base, mode, youtubeHelper) =>
  ...
  `function _rwUrl(u){try{if(typeof u!=="string"||!u)return u;return c.rewrite(u,_base())}catch(e){return u}}` +
